<div class="bg-white">
    <div class="max-w-4xl mx-auto py-16 sm:px-6 sm:py-24">
        <div class="px-4 sm:px-0">
            ...
            <p class="mt-2 text-sm text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatum
                architecto soluta dicta tempora. Architecto laborum magni, molestias dolorum tempore deserunt..</p>
        </div>
                    ...
                    <div
                        ...
                        <dl
                            ...
                            <div class="flex justify-between pt-4 font-medium text-gray-900 md:block md:pt-0">
                                <dt>Total amount</dt>
                                <dd class="md:mt-1">Rp 5.000,00</dd>
                            </div>
                        </dl>
                            ...
                            <div class="flex py-6 sm:py-10">
                                <div class="min-w-0 flex-1 lg:flex lg:flex-col">
                                    <div class="lg:flex-1">
                                        <div class="sm:flex">
                                            <div>
                                                <h4 class="font-medium text-gray-900">Lemon tea</h4>
                                                <p class="hidden mt-2 text-sm text-gray-500 sm:block">Lorem ipsum dolor
                                                    sit amet consectetur adipisicing elit. Quas, cupiditate.</p>
                                            </div>
                                            <p class="mt-1 font-medium text-gray-900 sm:mt-0 sm:ml-6">Rp 5.000,00</p>
                                        </div>
                                        <div class="mt-2 flex text-sm font-medium sm:mt-4">
                                            <a href="#" class="text-indigo-600 hover:text-indigo-500">View
                                                Product</a>
                                            <div class="border-l border-gray-200 ml-4 pl-4 sm:ml-6 sm:pl-6">
                                                <a href="#" class="text-indigo-600 hover:text-indigo-500">Buy
                                                    Again</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="ml-4 flex-shrink-0 sm:m-0 sm:mr-6 sm:order-first">
                                    <img src="https://images.unsplash.com/photo-1556679343-c7306c1976bc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1364&q=80"
                                        alt="Lemon tea."
